...
class Conv2dBatchLeaky(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, leaky_slope=0.1):
        ...
        # BatchNorm2d： 二维图像数据批量归一化
        # Conv2d：定义二维卷积层
        # stride=(2,1) 2:水平滑动长度 1：垂直滑动长度 此处看参数传递设置
        # padding:pytorch默认为valid,会忽略边缘信息，padding=1指图像上下左右都增加1行或一列0
        # padding=(1,1)，第一个1指高度上面的padding，第二个1指宽度上面的padding
...
if __name__ == "__main__":
    # 5：batch size 3: 输入通道数 416：垂直像素数 416水平像素数
